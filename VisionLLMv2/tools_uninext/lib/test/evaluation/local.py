...
def local_env_settings():
    ...
    settings.lasot_path =  'datasets/LaSOT/'                    # '/Data/Datasets/LaSOT/LaSOTBenchmark'
    settings.lasotext_path = 'datasets/LaSOT_extension_subset'  # '/Data/Datasets/LaSOT/LaSOT_extension_subset'
    settings.tnl2k_path = 'datasets/TNL-2K'                     # "/Data/Datasets/TNL2K/test"
