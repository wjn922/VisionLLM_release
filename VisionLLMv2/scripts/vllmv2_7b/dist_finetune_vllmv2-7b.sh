...
# e.g.
# s8a bash scripts/vllmv2_7b/dist_finetune_vllmv2-7b.sh work_dirs/visionllmv2-7b-pure-ft-uninext work_dirs/visionllmv2-7b-pure visionllmv2/datasets/configs/uninext/uninext_train.py