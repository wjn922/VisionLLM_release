...
from prompts_sot import QUESTIONS, ANSWERS

def sot_to_llava(vos_json_path, output_jsonl_path, num_samples=None, max_turns=3):
    """
    将SOT格式的JSON数据转换为LLAVA对话格式的JSONL数据
